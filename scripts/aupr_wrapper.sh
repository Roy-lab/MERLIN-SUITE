...
#ROylab GitHub location: https://github.com/Roy-lab/scRNAseq_NetInference/tree/master/scripts/wrapper_metrics/AUPR
scRNAseq_NetInference/scripts/wrapper_metrics/AUPR/getPR_cpp/getPR $1 $2 0 1 $3.txt
java -jar scRNAseq_NetInference/scripts/wrapper_metrics/AUPR/aupr/auc.jar $3.txt PR $e $c > $3.out.txt
